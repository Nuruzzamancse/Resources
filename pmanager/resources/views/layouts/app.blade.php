                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        @else
                            ...
                            <li><a href="{{ route('projects.index') }}"> <i class="fas fa-briefcase"></i> </i> Projects</a></li>
    ...
    @if(Auth::user()->role_id==1)
            ...
            <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" aria-haspopup="true">
                    <i class="fas fa-user-secret"></i>    Admin <span class="caret"></span>
                </a>

                <ul class="dropdown-menu">
                    <li><a href="{{ route('companies.index') }}"> <i class="fas fa-building"></i> All Companies</a></li>
                    <li><a href="{{ route('projects.index') }}"> <i class="fas fa-briefcase"></i> All Project</a></li>
                    <li><a href="{{ route('users.index') }}"> <i class="fas fa-user"></i> All User</a></li>
