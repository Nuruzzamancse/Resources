...
if(isset($_POST['submit_button'])){
    ...
    elseif(empty($_POST['password'])) {
        ...
        $sql = "SELECT user_id, password FROM tbl_users WHERE user_id=? AND 
  password=? ";
...
//						include("config.php");
//
////						 $query = "SELECT user_id, password FROM tbl_users WHERE user_id=$first_name AND password=$last_name"
//
//						$query = $DB->prepare("SELECT * FROM tbl_users WHERE user_id=:$first_name AND password=$last_name");
//						$query->execute();
//
                        ...
                        <div class="mt-4">
                            <form name="login_form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <input placeholder="First Name" title="Enter User ID" type="text" name="user_id" class="form-control" value="<?php echo (isset($_POST['first_name'])?$_POST['first_name']:''); ?>"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <input placeholder="Last Name" title="Enter Last Name" type="text" name="password" class="form-control" value="<?php echo (isset($_POST['last_name'])?$_POST['last_name']:''); ?>"/>
